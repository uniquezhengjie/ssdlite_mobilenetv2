...
tf.flags.DEFINE_string('train_image_dir', '/data1/datasets/coco/images/train2017/', 'Training image directory.')
tf.flags.DEFINE_string('val_image_dir', '/data1/datasets/coco/images/val2017/', 'Validation image directory.')
tf.flags.DEFINE_string('train_annotations_file', '/data1/datasets/coco/annotations/instances_train2017.json ',
