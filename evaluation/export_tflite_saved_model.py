...
flags.DEFINE_string(
    'pipeline_config_path', 'config/ssdlite_mobilenet_v2_0.5_200x200_coco.config',
    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
    'file.')
flags.DEFINE_string('trained_checkpoint_dir', 'coco_model',
                    'Path to trained checkpoint directory')
flags.DEFINE_string('output_directory', 'coco_saved_model_tflite', 'Path to write outputs.')
flags.DEFINE_string(
